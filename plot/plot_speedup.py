...
image_names = [prefix + '/results/fft/cufft-speedups.png',
               prefix + '/results/fft/cufft-throughput.png']
y_columns = ['turn_time', 'throughput(kp/s)']
...
def plot_throughput(data, image_name):
    ...
    plt.grid(True, which='major', alpha=0.5)
    plt.xlabel('log10(points)')
    plt.ylabel('Throughput (KPoints/sec)')
    # plt.title('Scalability')
